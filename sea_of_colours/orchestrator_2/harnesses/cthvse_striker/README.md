> ### This directory is yours — CTHVSE_STRIKER
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/cthvse_striker/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/cthvse_striker/_v7/chat_schema.py
...
Prefer changing `cthvse_striker/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `CTHVSE_STRIKER_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `CTHVSE_STRIKER_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
