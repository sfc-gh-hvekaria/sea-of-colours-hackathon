"""emp_harvest_test — OUT-OF-GRID KNOWLEDGE: what you can SENSE but cannot SEE.
...
from sea_of_colours.orchestrator_2.harnesses.emp_harvest_test.world_view import (
    _live_rows,
    _my_probe_cells,
    _tier,
)
